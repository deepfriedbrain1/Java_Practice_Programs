...
public interface ListInterface<T>
{
     ...
     * Entries originally at positons higher than the given position are at the next lower position within the list.
     * @param givenPosition An integer that indicates the positon of the entry to be removed.
     * @return A reference to the removed entry.
     * @throws IndexOutOfBoundsException if either newPosition < 1 or newPosition > getLength().
     */
     ...
     * @param givenPositon An integer that indicates the position of the desired entry.
